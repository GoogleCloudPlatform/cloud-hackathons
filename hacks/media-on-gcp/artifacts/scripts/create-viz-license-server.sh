...
gcloud compute instances create $VM_NAME \
	...
	--create-disk=auto-delete=yes,boot=yes,device-name=$VM_NAME,image=projects/windows-cloud/global/images/windows-server-2022-dc-v20250710,mode=rw,size=50,type=pd-balanced \
