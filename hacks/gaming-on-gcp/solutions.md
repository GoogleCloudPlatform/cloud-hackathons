...
1. **Build and push the Docker image for the custom matchmaking function and reapply the mmf.yaml:** With the changes made to the matchmaking function, we will need a new image.
