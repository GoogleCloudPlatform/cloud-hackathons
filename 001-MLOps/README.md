...
In this hack you will solve a common challenge for companies to continuously deploy an AI model and maintain it in production. You will see how you can adopt standard engineering practices around Cloud Build and CICD process on ML lifecycle to get real business value.
...
-  Challenge 1: **[Run model locally & and import repo into Cloud Build](Student/Challenge-01.md)**
-  Challenge 2: **[Create a Build pipeline in Cloud Build](Student/Challenge-02.md)**
-  Challenge 3: **[Create a Unit Test in Cloud Build](Student/Challenge-03.md)**
-  Challenge 4: **[Create a Release pipeline in Cloud Build](Student/Challenge-04.md)**
